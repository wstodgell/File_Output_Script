...
# Common patterns for Python virtual environments
virtual_env_patterns = {'venv', 'env', '.venv', 'myenv'}

# Check if the directory should be excluded
def is_excluded_dir(dir_name):
    print(f"Checking directory: {dir_name}")  # Debugging information
    return (
        dir_name.startswith('.') or
        dir_name in excluded_dirs or
        dir_name == '__pycache__' or
        any(dir_name.lower().startswith(pattern) for pattern in virtual_env_patterns)
    )
